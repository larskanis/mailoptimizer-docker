...
```sh
cp ~/I/PROG/_post/Mailoptimizer/MO_Installer-2025-03-18.zip .
cp ~/I/PROG/_post/Mailoptimizer/2022-02-23_Mo_config_15420_5046577760.xml .
rm -rf mo-installer
mkdir -p mo-installer
unzip -d mo-installer MO_Installer-2025-03-18.zip
rm MO_Installer-2025-03-18.zip
...
cp MO_Installer.zip ~/I/PROG/_post/Mailoptimizer/MO_Installer-2025-03-18.zip
rm MO_Installer.zip
```
